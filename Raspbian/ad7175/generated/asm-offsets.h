...
#define PV_IRQ_save_fl 0 /* offsetof(struct pv_irq_ops, save_fl) */
...
#define TASK_threadsp 11864 /* offsetof(struct task_struct, thread.sp) */
...
#define TASK_addr_limit 11992 /* offsetof(struct task_struct, thread.addr_limit) */
