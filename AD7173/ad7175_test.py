...
class ADC7173:
    ...
    def init(self):
        ...
        value[1] &= 0xF0
        valid_id = value[0] == 0x3C and value[1] == 0xD0
...
adc.enable_channel(ADC7173.CH0, True, ADC7173.AIN0, ADC7173.AIN0)
adc.enable_channel(ADC7173.CH1, True, ADC7173.AIN1, ADC7173.AIN1)
adc.enable_channel(ADC7173.CH2, True, ADC7173.AIN2, ADC7173.AIN2)
adc.enable_channel(ADC7173.CH3, True, ADC7173.AIN3, ADC7173.AIN3)


# set the ADC filter samplingrate to 1007 Hz*/
# FILTER0 - FILTER7
# SPS_5, SPS_10, SPS_16, SPS_20, SPS_50, SPS_60, SPS_100, SPS_200, SPS_400, SPS_500, SPS_1000
# SPS_2500, SPS_5000, SPS_10000, SPS_15000, SPS_25000, SPS_31000, SPS_50000, SPS_62000, 
# SPS_125000, SPS_250000
adc.set_filter_speed(ADC7173.FILTER0, ADC7173.SPS_2500)
# set the ADC setup coding to BIPLOAR output*/
# SETUP0 - SETUP7
# BIPOLAR, UNIPOLAR
adc.set_setup_coding_mode(ADC7173.SETUP0, ADC7173.UNIPOLAR)
...
while True:
    ...
    if channel1 == None:
        channel1 = data
    	print("channel 1 take")
	print(channel1[0])
	print(channel1[1])
	print(channel1[2])

	value = ord(channel1[0]) << 16 | ord(channel1[1]) << 8 | ord(channel1[2])
		# convert from offset binary
		value -= 8388608
		# print the value in hexadecimal and decimal format
		print "HEX:", channel1[0].encode('hex'), channel1[1].encode('hex'), channel1[2].encode('hex'), "DEC:", value
	
  # capture second channel

    if channel2 == None:
        channel2 = data
        print("channel 2 take")
        print(channel2[0])
        print(channel2[1])
        print(channel2[2])
